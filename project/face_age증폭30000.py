...
ic(type(x_augment), x_augment.shape)       # <class 'numpy.ndarray'>, (30000, 32, 32, 3)
print('%%%%%%%%%%%%%%% 2 %%%%%%%%%%%%%%%%')
ic(x_train.shape, x_augment.shape)  #(880, 32, 32, 3), (30000, 32, 32, 3)
ic(y_train.shape, y_augment.shape)  #(880, 11), (30000, 11)
...
print('%%%%%%%%%%%%%%% 3 %%%%%%%%%%%%%%%%')
ic(x_train.shape, y_train.shape)        #  (30880, 32, 32, 3), (30880, 11)
...
'''
    x_train.shape: (30880, 32, 32, 3)
    x_test.shape: (220, 32, 32, 3)
    y_train.shape: (30880, 11)
    y_test.shape: (220, 11)
...
### 넘파이로 세이브하기
np.save('./_save/_npy/proj_faceage_aug3_x_train.npy', arr=x_train)
np.save('./_save/_npy/proj_faceage_aug3_x_test.npy', arr=x_test)
np.save('./_save/_npy/proj_faceage_aug3_y_train.npy', arr=y_train)
np.save('./_save/_npy/proj_faceage_aug3_y_test.npy', arr=y_test)
np.save('./_save/_npy/proj_faceage_aug3_x_pred.npy', arr=x_pred)
np.save('./_save/_npy/proj_faceage_aug3_y_pred.npy', arr=y_pred)


# ============================================================================================================

### 데이터 로드하기
# x_train = np.load('./_save/_npy/proj_faceage_aug3_x_train.npy')
# x_test = np.load('./_save/_npy/proj_faceage_aug3_x_test.npy')
# y_train = np.load('./_save/_npy/proj_faceage_aug3_y_train.npy')
# y_test = np.load('./_save/_npy/proj_faceage_aug3_y_test.npy')
# x_pred = np.load('./_save/_npy/proj_faceage_aug3_x_pred.npy')
# y_pred = np.load('./_save/_npy/proj_faceage_aug3_y_pred.npy')
