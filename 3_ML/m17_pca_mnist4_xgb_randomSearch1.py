# 실습
# m13로 만든 0.999 이상의 n_component=? 를 사용하여 xgb 모델을 만들 것(default)
...
# ic(np.argmax(cumsum >= 0.95)+1)     # 154 # 전체 컬럼 수 n_components에 넣어서 원하는 피쳐임포턴스 수치의 컬럼 수 찾고, 나온 수 n_components에서 넣어주면 됨
...
'''
* RandomCV
최적의 매개변수 : {'n_jobs': -1, 'n_estimators': 90, 'max_depth': 6, 'learning_rate': 0.1, 'colsample_bytree': 0.9, 'colsample_bylevel': 0.6}
best_score : 0.8291006785662995
r2 : 0.819087752300636

* (최적의 매개변수 사용) XGBRegressor
r2 : 0.8222092518131208
'''