...
np.save('./_save/_npy/k16_5_test_y.npy', arr=testGen[0][1])
np.save('./_save/_npy/k61_5_predict_x.npy', arr=predictGen[0][0])
np.save('./_save/_npy/k16_5_predict_y.npy', arr=predictGen[0][1])

# ============================================================================

# x_train = np.load('./_save/_npy/k61_5_train_x.npy')
# y_train = np.load('./_save/_npy/k61_5_train_y.npy')
# x_test = np.load('./_save/_npy/k61_5_train_y.npy')
# y_test = np.load('./_save/_npy/k16_5_test_y.npy')
# x_pred = np.load('./_save/_npy/k61_5_predict_x.npy')
# y_pred = np.load('./_save/_npy/k16_5_predict_y.npy')
# print('****************** 1 *****************')
