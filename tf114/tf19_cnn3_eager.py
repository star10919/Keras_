...
### disable_eager_execution : tensorflow1에서 2사용가능
...
##### tensorflow 1
## layer 1
w1 = tf.compat.v1.get_variable('w1', shape=[3, 3, 1, 32])   # [kernel_size, input의 channel(color) 수(맨 마지막), output]
...
## layer 4
w4 = tf.compat.v1.get_variable('w4', shape=[2, 2, 128, 64],)# initializer=tf.contrib.layers.xavier_initializer())       # 가중치초기화 : 가중치폭발을 막기 위해서
...
layer7 = tf.matmul(layer6_activation, w7) + b7
