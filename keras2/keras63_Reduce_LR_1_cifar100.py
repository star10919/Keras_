...
model = Sequential()
model.add(Conv2D(128, kernel_size=(2, 2), padding='valid', input_shape=(32, 32, 3), activation='relu'))
...
from tensorflow.keras.callbacks import EarlyStopping, ReduceLROnPlateau     # ReduceLROnPlateau : LR을 감축시키겠다
...
hist = model.fit(x_train, y_train, epochs=200, verbose=1, callbacks=[es, reduce_lr], validation_split=0.2,
