...
# 3. 컴파일(ES, reduce_lr), 훈련           metrics['acc]
...
import time
start = time.time()
model.fit(x_train, y_train, epochs=1000, batch_size=512, validation_split=0.0012, callbacks=[es, reduce_lr])
end = time.time() - start
...
*reduce LR
걸린시간 : 51.23380732536316
category : 0.09620117396116257
accruacy : 0.9830999970436096
'''